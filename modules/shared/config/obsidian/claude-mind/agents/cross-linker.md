...
- `AI/org/people/*.md` — every person name (including aliases from frontmatter)
- `AI/org/teams/*.md` — every team name
- `AI/perf/competencies/*.md` — every competency name
- `AI/work/active/*.md`, `AI/work/archive/**/*.md` — every project name
- `AI/work/incidents/*.md` — every incident name
...
Write findings to `AI/thinking/cross-link-audit-YYYY-MM-DD.md` with:
