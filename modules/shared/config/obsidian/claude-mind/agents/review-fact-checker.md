...
3. For each claim, search the vault:
   - `AI/perf/evidence/` for PR data
   - `AI/perf/<cycle>/` for review briefs
   - `AI/perf/brag/` for quarterly brag notes
   - `AI/perf/competencies/` for competency criteria
   - `AI/work/` for project notes
   - `AI/org/people/` for person notes
   - `AI/brain/` for operational context
