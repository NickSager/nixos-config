...
- Person → `AI/org/people/<Name>.md`
- Project → `AI/work/active/<Name>.md` or `AI/work/archive/**/<Name>.md`
- Incident → `AI/work/incidents/<Name>.md`
- Team → `AI/org/teams/<Name>.md`
- Concept → search `AI/brain/`, `AI/reference/`
...
- `AI/work/` — project context, incident timelines
- `AI/work/1-1/` — meeting discussions about this topic
- `AI/perf/` — brag entries, evidence, review briefs
- `AI/brain/` — memories, patterns, decisions, gotchas
