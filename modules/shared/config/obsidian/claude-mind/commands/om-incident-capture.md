...
- Check if they have a person note in `AI/org/people/`
...
Create `AI/work/incidents/<Incident Name>.md` with:
...
- Create in `AI/org/people/` with proper frontmatter (`date`, `title`, `description`, `team`, `tags: [person]`)
- Add to `AI/org/People & Context.md`
...
- `AI/work/Index.md` — add to Incidents section
- `AI/brain/Memories.md` — add incident summary to Recent Context
- `AI/brain/Patterns.md` — if this reveals a recurring pattern
- `AI/brain/Gotchas.md` — if this reveals a technical gotcha
- `AI/perf/Brag Doc.md` — add to relevant quarter with competency links
- `AI/perf/brag/QN YYYY.md` — add detailed brag entry

### 7. Prepare Incident Report Draft (if applicable)

If you are or may lead the post-mortem:
- Check your org's post-mortem template (add it to `AI/reference/` if you have one)
- Create `AI/work/incidents/TICKET-XXXX Post-Mortem Draft.md` following your org's post-mortem template
