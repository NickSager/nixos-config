...
- `AI/brain/North Star.md` — how you write about yourself
- The most recent `AI/work/1-1/*.md` note — natural conversational voice
...
- **`AI/work/1-1/`** → conversational, direct, uses "I", okay to be informal
- **`AI/perf/` review content** → corporate-confident but human, evidence-based, respect charcount
- **`AI/work/incidents/`** → precise, factual, timeline-oriented, no filler
- **`AI/brain/`** → terse shorthand, fragments okay
...
- If charcount matters (review content in `AI/perf/`), verify limits after editing with `.claude/scripts/charcount.sh`.
