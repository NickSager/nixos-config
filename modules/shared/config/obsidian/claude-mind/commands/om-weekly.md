...
- Read any `AI/work/1-1/*.md` notes from this week
- Check `AI/work/active/` for status changes
- Check `AI/work/incidents/` for new or updated incidents
- Read today's daily note if it exists: `obsidian daily:read`

### 2. North Star Alignment

Read `AI/brain/North Star.md` and compare actual activity against stated focus:
...
Additionally check:
- Were completed items logged in `AI/perf/Brag Doc.md` or the current quarter's brag note?
...
- "Want me to save this as `AI/thinking/weekly-YYYY-MM-DD.md`?"
