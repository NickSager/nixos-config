...
Load in order:
1. Person note from `AI/org/people/<Name>.md`
2. PR evidence from `AI/perf/evidence/<Name> PRs - <cycle>.md` (run `/om-peer-scan` if missing)
3. Peer review notes from `AI/work/active/` (any active review writing notes)
...
After submission, promote to `AI/perf/<cycle>/Peer Review - <Full Name>.md`.
