...
- In the correct folder? (`AI/work/active/` vs `AI/work/archive/` vs `AI/work/incidents/` etc.)
- Description accurate and ~150 chars?
- Status field correct?

### 3. Check Index Consistency

- `AI/work/Index.md` — are new notes linked? Are completed projects in the right section?
- `AI/brain/Memories.md` — does Recent Context reflect what happened this session?
- `AI/org/People & Context.md` — any new people or relationship changes to capture?
- `AI/perf/Brag Doc.md` — any wins or achievements from this session?
...
- Are there notes in `AI/work/active/` that should be moved to `AI/work/archive/YYYY/`?
- Any status fields still `active` that should be `completed`?

### 6. Ways of Working Review

Check if this session revealed:
- A new pattern that should be in `AI/brain/Patterns.md`?
- A new gotcha that should be in `AI/brain/Gotchas.md`?
- A workflow improvement for `AI/brain/Skills.md`?
