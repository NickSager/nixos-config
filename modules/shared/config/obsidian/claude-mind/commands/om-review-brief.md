...
- `AI/perf/<cycle>/Review Brief.md` (or current private brief) — full context
- `AI/perf/Brag Doc.md` — quarterly highlights
- `AI/perf/brag/Q*.md` — quarterly detail notes for the period
- `AI/perf/evidence/Your PRs - *.md` — PR data
- `AI/work/*.md` — project notes for the period
- `AI/perf/competencies/*.md` — competency definitions
...
- Cross-check PR counts and dates against `AI/reference/` data
