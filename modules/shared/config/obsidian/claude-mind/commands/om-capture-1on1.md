...
2. **Create work note** at `AI/work/1-1/<Participant> <YYYY-MM-DD>.md` with:
...
4. **Update related notes**:
   ...
   - `AI/work/Index.md` (add to Review Prep or Active Projects as appropriate)
   - `AI/brain/Memories.md` if any context changed (manager dynamics, priorities, etc.)
   - `AI/org/people/` note for the participant
