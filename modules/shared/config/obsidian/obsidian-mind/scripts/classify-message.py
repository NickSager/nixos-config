...
SIGNALS = [
    {
        "name": "DECISION",
        "message": "DECISION detected — consider creating a Decision Record in AI/work/active/ and logging in AI/work/Index.md Decisions Log",
        "patterns": [
            # English
    ...
    {
        "name": "INCIDENT",
        "message": "INCIDENT detected — consider using /om-incident-capture or creating an incident note in AI/work/incidents/",
        "patterns": [
            # English
    ...
    {
        "name": "1:1 CONTENT",
        "message": "1:1 CONTENT detected — consider creating a 1-on-1 note in AI/work/1-1/ and updating the person note in AI/org/people/",
        "patterns": [
            # English
    ...
    {
        "name": "WIN",
        "message": "WIN detected — consider adding to AI/perf/Brag Doc.md with a link to the evidence note",
        "patterns": [
    ...
    {
        "name": "ARCHITECTURE",
        "message": "ARCHITECTURE discussion — consider creating a reference note in AI/reference/ or a decision record",
        "patterns": [
            # English
    ...
    {
        "name": "PERSON CONTEXT",
        "message": "PERSON CONTEXT detected — consider updating the relevant person note in AI/org/people/ and linking from the conversation note",
        "patterns": [
            # English
    ...
    {
        "name": "PROJECT UPDATE",
        "message": "PROJECT UPDATE detected — consider updating the active work note in AI/work/active/ and checking if wins should go to brag doc",
        "patterns": [
            # English
