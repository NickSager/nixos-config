...
Read in order:
1. `AI/brain/North Star.md` — current goals and focus
2. `AI/perf/<cycle>/Review Brief.md` — the full private review brief
3. `AI/perf/<cycle>/Review Brief - Manager.md` — what the manager has seen
4. Previous cycle review — baselines
5. Quarterly brag notes covering the period
6. All competency notes in `AI/perf/competencies/`
7. `AI/perf/Performance Framework.md` — evaluation structure (if exists)
...
Save draft to `AI/thinking/review-drafts.md` for copy-pasting.
After submission, promote to `AI/perf/<cycle>/Self-Review.md`.
