...
Deep scan a peer's GitHub PRs for performance review preparation. Produces a structured analysis saved to `AI/perf/evidence/`.
...
4. **Save to vault** as `AI/perf/evidence/<Name> PRs - <Period>.md` with frontmatter:
   ```yaml
   ---
   date: "<today>"
